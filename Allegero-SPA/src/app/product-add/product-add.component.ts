...
export class ProductAddComponent implements OnInit {
  ...
  createProductForm(){
    this.productForm = this.formBuilder.group({
      ...
      p1_Desc: [this.editingAuction.p1_Desc],
      p2_Desc: [this.editingAuction.p2_Desc],
      p3_Desc: [this.editingAuction.p3_Desc],
      p4_Desc: [this.editingAuction.p4_Desc],
      p5_Desc: [this.editingAuction.p5_Desc],
